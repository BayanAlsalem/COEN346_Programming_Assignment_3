...
public class Scheduler extends Thread{
    ...
    {
        //finish the process by removing it from the queue of all processes.txt and the ready queue.
    }
    void fill_ready_queue()
    {
        //we need the clock to fill our ready processes.txt to the queue.
    ...
    //todo: use A semaphore to make sure that we are running two processes.txt at the same time.
